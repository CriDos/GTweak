...
이 포크 버전은 트윅을 적용하기 전에 GTweak을 더 쉽게 이해할 수 있도록 합니다. 토글 로직은 Windows 기능의 상태가 아니라 트윅 자체의 상태를 보여주도록 바뀌었습니다. 초록색은 트윅이 적용됨을 의미하고, 회색은 트윅이 적용되지 않음을 의미합니다. 설명 패널에는 서비스, 개인 정보, 인터페이스, 시스템 설정처럼 각 섹션에 맞는 안내 문구도 추가되었습니다. 목표는 켜진 토글이 Windows 기능을 켜는 것인지, 그 기능을 끄는 트윅을 적용하는 것인지 헷갈리던 기존 UX를 줄이는 것입니다.
