...
---
<h2 dir="rtl"> גרסת UX rework</h2>

<p dir="rtl">גרסה זו של הפורק הופכת את GTweak לברור יותר לפני שמחילים טוויקים. לוגיקת המתגים עובדה מחדש כך שהממשק מציג את מצב הטוויק עצמו: ירוק פירושו שהטוויק הוחל, אפור פירושו שהוא לא הוחל. לוח התיאור מסביר כעת מה המשמעות בכל אזור, למשל שירותים, פרטיות, ממשק או הגדרות מערכת. המטרה היא להסיר את העמימות הישנה שבה מתג פעיל יכול היה להתפרש כהפעלת תכונה של Windows או כהחלת טוויק שמכבה אותה.</p>
