...
---
<h2> เวอร์ชัน UX rework</h2>

เวอร์ชันฟอร์กนี้ทำให้ GTweak เข้าใจง่ายขึ้นก่อนกดใช้ทวีคใด ๆ ตรรกะของสวิตช์ถูกปรับใหม่ให้แสดงสถานะของทวีคเอง: สีเขียวหมายถึงทวีคถูกใช้แล้ว สีเทาหมายถึงยังไม่ได้ใช้ทวีค แผงคำอธิบายจะแสดงความหมายแยกตามแต่ละหน้า เช่น บริการ ความเป็นส่วนตัว อินเทอร์เฟซ และการตั้งค่าระบบ เป้าหมายคือแก้ความสับสนเดิมที่สวิตช์เปิดอาจถูกเข้าใจได้ทั้งว่าเปิดฟีเจอร์ของ Windows หรือใช้ทวีคที่ปิดฟีเจอร์นั้น
