...
---
<h2> UX rework версія</h2>

Ця версія форка робить GTweak зрозумілішим перед застосуванням твиків. Логіку перемикачів перероблено так, щоб інтерфейс показував стан самого твіка: зелений означає, що твік застосовано, сірий — що твік не застосовано. У панелі опису тепер є окрема підказка для кожної вкладки: служби, приватність, інтерфейс і системні налаштування пояснюються своїм текстом. Мета — прибрати стару неоднозначність, коли увімкнений перемикач можна було прочитати і як увімкнення функції Windows, і як застосування твіка, що цю функцію вимикає.
